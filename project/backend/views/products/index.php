...
<table id="products-table" class="table table-bordered product_list_table">
    <thead>
        <tr class="header">
            ...
            <th class="brand-name">Tên nhãn hàng</th>
        ...
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td class="action">
                    ...
                    <a <?= $disabled_member?> title="Cập nhật" href="<?php echo $url_update ?>"><i class="fa fa-pencil-alt"></i></a> &nbsp;&nbsp;
    ...
    <?php else: ?>
        <tr>
            <td colspan="9"><h2>Không tìm được dữ liệu</h2></td>
        </tr>
    <?php endif; ?>
    </tbody>
</table>
