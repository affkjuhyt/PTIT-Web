...
class CategoryController extends Controller
{
  public function test_layout(){
    require_once 'views/layouts_new/main.php';
  }
  ...
  public function index()
  {
    ...
    $this->content = $this->view('views/categories/index.php', [
  ...
  public function create()
  {
    if (isset($_POST['submit'])) {
      ...
      if (empty($name)) {
        ...
        $extension_arr = ['jpg', 'jpeg', 'gif', 'png', 'webp'];
    ...
    $this->content = $this->view('views/categories/create.php');
    require_once 'views/layouts/main.php';
  }
  ...
  public function update()
  {
    ...
    $this->content = $this->view('views/categories/update.php', [
        'category' => $category
    ]);
    require_once 'views/layouts/main.php';
  }
  ...
  public function detail()
  {
    ...
    $this->content = $this->view('views/categories/detail.php', [
      'category' => $category
    ]);
